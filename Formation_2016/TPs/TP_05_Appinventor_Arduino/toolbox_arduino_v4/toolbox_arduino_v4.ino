/* This file is meant to be used with the SCILAB arduino  
 ...
 Stepper
 Paij : setup for stepper with driver using pwm_step (number i) and dir (number j)
 PmiXXXXYY : sets movement during direction i (0/1), nb steps described over 4 bytes separated by dt described over 2 bytes
